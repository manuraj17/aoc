...
class Monkey
  attr_accessor :id, :starting_items, :items_inspected

  def initialize(id:, starting_items:, operation:, test:, true_monkey:, false_monkey:)
    @id = id
    # Array of items
